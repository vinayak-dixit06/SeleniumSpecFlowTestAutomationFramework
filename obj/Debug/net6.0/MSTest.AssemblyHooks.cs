...
[TestClass]
public class SeleniumSpecFlowTestAutomationFramework_MSTestAssemblyHooks
{
    [AssemblyInitialize]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public static void AssemblyInitialize(TestContext testContext)
    {
        var currentAssembly = typeof(SeleniumSpecFlowTestAutomationFramework_MSTestAssemblyHooks).Assembly;
